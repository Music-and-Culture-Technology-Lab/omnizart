...
from omnizart.legacy.setting_loaders import ChordSettingsVamp
...
from omnizart.legacy.chord_vamp.features_vamp import extract_feature_label
from omnizart.legacy.chord_vamp.inference_vamp import inference, write_csv
from omnizart.train import get_train_val_feat_file_list
from omnizart.legacy.models.chord_model import ChordModelVamp, ReduceSlope


logger = get_logger("Chord Application")


class ChordTranscriptionVamp(BaseTranscription):
    """Application class for chord transcription."""
    def __init__(self, conf_path=None):
        super().__init__(ChordSettingsVamp, conf_path=conf_path)

...
from omnizart.constants.datasets import BeatlesSturcture
...
class ChordTranscription(BaseTranscription):
    ...
    def generate_feature(self, dataset_path, chord_settings=None, num_threads=4):
        ...
        * chord_change: the second type of the ground-truth
        ...
        train_data_pair = BeatlesSturcture.get_train_data_pair(dataset_path)
        test_data_pair = BeatlesSturcture.get_test_data_pair(dataset_path)
...
def _write_feature(feature, out_path):
    key_list = ["cqt", "chord", "chord_change", "len", "frame_id"]
...
class BeatlesLoader(BaseDatasetLoader):
